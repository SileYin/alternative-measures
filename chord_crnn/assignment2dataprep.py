...
pcalltrackmatrix = np.empty([3000,3570,12])
tballtrackmatrix = np.empty([3000,3570,12])
# labelmatrix = []
# pcalltrackmatrix = []
# tballtrackmatrix = []
